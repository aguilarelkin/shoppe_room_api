...
fun Operation(
    ...
    Scaffold(
        ...
        DataOperation(id, operationViewModel, navController, infoViewModel, paddingValues)
    }
}
                ...
                Row(
                    ...
                    Column(
                        ...
                        FieldName(dataValue = productData.value.discountPercentage.toString()) {
                            productData.value = productData.value.copy(
                                discountPercentage = validDouble(
                                    it
                                )
                            )
                        }
...
private fun dataOperation(
    ...
    if (id == null) {
        operationViewModel.addProduct(product)
    } else {
        operationViewModel.updateProduct(product)
    }
}
